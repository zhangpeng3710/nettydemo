...
graph LR
    subgraph 渠道
        CH_S["stable 渠道<br/>→ v1.2.0"]
        CH_P["preview 渠道<br/>→ v1.3.0"]
        CH_F["custom-CUST_F 渠道<br/>→ v1.2.0-CUST_F"]
        CH_X["custom-GROUP_X 渠道<br/>→ v1.1.0-GROUP_X"]
    end
    ...
    subgraph 租户
        ...
        T2["租户B (stable)"] --> CH_S
        T3["租户C (stable)"] --> CH_S
        T4["种子租户D (preview)"] --> CH_P
        T5["种子租户E (preview)"] --> CH_P
        T6["租户F (custom-CUST_F)"] --> CH_F
        T7["租户G (custom-GROUP_X)"] --> CH_X
        T8["租户H (custom-GROUP_X)"] --> CH_X
    end
```
